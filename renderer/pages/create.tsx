...
export default function Create() {
  ...
  return (
    <div className="w-full flex-col gap-10 justify-center">
      <Button className="w-[90px] h-[50px] mt-4" onClick={handleHomeClick}>
        Home
      </Button>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div className="grid grid-cols-2 gap-4 gap-y-14">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col items-center">
                  <FormLabel>Size of the Home {`(in m^2)`}</FormLabel>
                  <FormControl>
                    <Input
                      className="max-w-[920px] bg-white"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col items-center">
                  <FormLabel>Interior Features</FormLabel>
                  <FormControl>
                    <Input
                      className="max-w-[920px] bg-white"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col items-center">
                  <FormLabel>Geographical Featues</FormLabel>
                  <FormControl>
                    <Input
                      className="max-w-[920px] bg-white"
